...
function App() {
  ...
  const getPromptForStyle = (style) => {
    const prompts = {
      ...
      markTwain: "Write a Mark Twain-style message to convince someone to join a game. Use the style of Mark Twain, with a mix of humor, irony, and wisdom.",
      ...
      viking: "Write a Viking-style rant to convince someone to join a game. Use Norse mythology and Viking language.",
      pirate: "Write as a pirate to convince someone to join a game. Use nautical terms, pirate slang.", 
      ...
      dadJokes: "Write a message using dad jokes to convince someone to join a game. Include puns, wordplay, and groan-worthy humor.",
      memeLord: "Write a message using internet meme culture, references, and viral phrases to convince someone to join a game. Include popular meme formats and references.",
      soapOpera: "Write an overly dramatic soap opera-style message to convince someone to join a game. Use dramatic pauses, emotional outbursts, and cliffhangers.",
      conspiracy: "Write a conspiracy theorist-style message to convince someone to join a game. Include wild theories, secret organizations, and hidden meanings.",
      infomercial: "Write an infomercial-style message to convince someone to join a game. Use over-the-top sales tactics, 'but wait, there's more!' moments, and dramatic before/after scenarios."
    }
